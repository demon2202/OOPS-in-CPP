...
10. What are the types of variables in OOP?
...
12. Implement a Stack data structure using a LinkedList in Python.
class Node:
...
13. Implement an abstract class in C# with an abstract method.
